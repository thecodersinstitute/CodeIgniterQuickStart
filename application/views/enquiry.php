    ...
    <?php } ?>
                ...
                <div class="table-responsive">
                  <table class="table table-striped b-t text-sm">
                    ...
                    <tbody>
					<?php foreach($enquiry  as $key =>$c){ ?>
                      <tr>
                        <td><input type="checkbox" name="post[]" value="2"></td>
                        <td><a  href="<?php echo site_url('dashboard/view_enquiry').'/'.$key;?>"><?php echo $c['name'];?></a></td>
                        <td><?php echo $c['qualification'];?></td>
                        <td><?php echo $c['stream'];?></td>
						
						<td><?php echo $c['course_interested_1'];?></td>
						<td><?php echo $c['conact_no'];?></td>
						<td><?php echo $c['email'];?></td>
						<td><a href="<?php echo site_url('dashboard/delete_enquiry').'/'.$key; ?>"><i class="fa fa-trash-o"></i></a>
						<a href="<?php echo site_url('dashboard/edit_enquiry').'/'.$key; ?>"><i class="fa fa-edit"></i></a>
						</td>
